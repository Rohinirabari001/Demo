...
<body>
    ...
    <!-- Page Content -->
    <div id="page-content-wrapper" style="inline-size: 90%">

      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        <img src="./images/Skyzer.jpg" style="inline-size: 30%";><br><br>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>View Client Information</h2></div>
                   <div> <input type="text" placeholder="Search.." name="search">
